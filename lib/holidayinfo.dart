                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: Text(s.data["name"], style: TextStyle(
                                                  color: Colors.black,
                                            ...
                                            Padding(
                                              ...
                                              child: Text(s.data["categories"][0]["name"] + ", " + s.data["categories"][1]["name"], style: TextStyle(
                                                  color: themeColor,
                                                  fontWeight: FontWeight.bold,
                                            ...
                                            Padding(
                                              ...
                                              child: Text(removeAllHtmlTags(s.data["description"]), style: TextStyle(
                                                  color: Colors.black,
                                                  letterSpacing: 0.2,
                                                  fontWeight: FontWeight.bold,
                                                ...
                                                children: <Widget> [
                                                  Column(
                                                    children: <Widget>[
                                                      Row(
                                                        children: <Widget>[
                                                          Text('€'+s.data["sale_price"], style: TextStyle(
                                                              color: themeColor,
                                                              fontWeight: FontWeight.bold,
                                                          ...
                                                          Text('€'+s.data["regular_price"], style: TextStyle(
                                                              color: Colors.grey,
                                                              fontWeight: FontWeight.bold,
                                                      ...
                                                      Text("Je bespaart : " + ((double.parse(s.data["sale_price"]) - double.parse(s.data["regular_price"])) / double.parse(s.data["regular_price"]) * 100).toString().substring(1,3) + "%", style: TextStyle(
                                                          color: themeColor,
                                                          fontWeight: FontWeight.bold,
